...
HRESULT player1::init()
{
	...
	_img = IMAGEMANAGER->addImage("player1Battle_Idle", ".//playerImage//player1_attack_idle.bmp", 28, 43, true, RGB(255, 0, 255));
...
{
	player::render();
	IMAGEMANAGER->render("player1Battle_Idle", getMemDC(), _x, _y, 40, 65);
}
